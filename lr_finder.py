...
def main():
    ...
    if checkpoint is None:
        ...
        {'params': model.pred_convs.parameters()}], lr=0.001, momentum=0.8)
        #scheduler = torch.optim.lr_scheduler.CyclicLR(optimizer, base_lr=[0.00001,0.0001,0.0004], max_lr=[0.0001,0.001, 0.009],step_size_up=31,step_size_down=31)
        #print(model)
    else:
        ...
        #                                               max_lr=[0.000005, 0.00005, 0.00008], step_size_up=31,
        #                                               step_size_down=31)
